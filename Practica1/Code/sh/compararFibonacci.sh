...
OUTPUT=./ImagenesComparacion/fibonacci_comparacion.png

FICHERO_DATOS1="./DatosAndres/tiempo_fibonacci.dat"
FICHERO_DATOS2="./DatosIvan/tiempo_fibonacci.dat"
FICHERO_DATOS3="./DatosAntonioMoya/tiempo_fibonacci.dat"
FICHERO_DATOS4="./DatosJuanLuis/tiempo_fibonacci.dat"

TITULO="Comparación de fibonacci entre computadores"
