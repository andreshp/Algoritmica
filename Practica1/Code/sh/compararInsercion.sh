...
OUTPUT=./ImagenesComparacion/insercion_comparacion.png

FICHERO_DATOS1="./DatosAndres/tiempo_insercion.dat"
FICHERO_DATOS2="./DatosIvan/tiempo_insercion.dat"
FICHERO_DATOS3="./DatosAntonioMoya/tiempo_insercion.dat"
FICHERO_DATOS4="./DatosJuanLuis/tiempo_insercion.dat"

TITULO="Comparación de insercion entre computadores"
