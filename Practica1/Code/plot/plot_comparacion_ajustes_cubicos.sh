...
OUTPUT=./ImagenesComparacion/comparacion_ajustes_floyd.png
TITULO="Comparación de diferentes ajustes para Floyd"
XLABEL="Longitud del Vector"
YLABEL="Tiempo (segundos)"
LEYENDA="Datos de Floyd"
LEYENDA1="n**2"
LEYENDA2="n**3"
LEYENDA3="((1+sqrt(5))/2)**n"
FICHERO_DATOS="./DatosAndres/tiempo_floyd.dat"
