...
plot "$FICHERO_DATOS" title '$LEYENDA' with points ls 4, f(x) title sprintf('f(x) = %.10f*x*log(x)', a_f) ls 1, g(x) title sprintf('g(x) = %.10f*x', a_g) ls 2, h(x) title sprintf('h(x) = %.10f*x*log(x)+%.10f*x', a1_h,a2_h) ls 3
FIN
