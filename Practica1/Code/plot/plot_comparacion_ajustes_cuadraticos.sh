...
OUTPUT=./ImagenesComparacion/comparacion_ajustes_insercion.png
TITULO="Comparación de diferentes ajustes para algoritmo de insercion"
XLABEL="Longitud del Vector"
YLABEL="Tiempo (segundos)"
LEYENDA="Datos de Insercion"
LEYENDA1="n**2"
LEYENDA2="n**3"
LEYENDA3="n"
FICHERO_DATOS="./DatosAndres/tiempo_insercion.dat"
