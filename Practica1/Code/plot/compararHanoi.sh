...
OUTPUT=./ImagenesComparacion/hanoi_comparacion.png

FICHERO_DATOS1="./DatosAndres/tiempo_hanoi.dat"
FICHERO_DATOS2="./DatosIvan/tiempo_hanoi.dat"
FICHERO_DATOS3="./DatosAntonioMoya/tiempo_hanoi.dat"
FICHERO_DATOS4="./DatosJuanLuis/tiempo_hanoi.dat"

TITULO="Comparación de hanoi entre computadores"
