...
MENSAJE_INICIO="Se inicia la ejecución del ejercicio 1:"
MENSAJE_FINAL="Fin de la ejecución del ejercicio 1. Se ha creado una imagen y un fichero con los resultados.\n"
