...
/* Programa que devuelve el tiempo que el algoritmo de ordenación burbuja
   tarda en ordenar un array de tamaño dado como parámetro en su peor caso. */

// El peor caso para el algoritmo burbuja tiene lugar cuando el vector está en orden inverso.
...
int main(int argc, char * argv[])
{
    ...
    for (int i = 0; i < size; i++){  // Se genera un vector en orden inverso: {size-1, size-2, ..., 2, 0}
        v[i] = size - i;
    }
