...
En el caso de éstos algoritmos, podemos ver que el algoritmo quicksort es más rápido. A parte de, cómo se ha explicado antes, el hecho de que los vectores se generan aleatoriamente, aquí debemos tener en cuenta que el algoritmo mergesort utiliza espacio extra, con lo que la reserva de dicho espacio supone un coste de tiempo. Comparando tambien el heapsort con el quicksort, ha de notarse que en el primero se crea el heap y luego se ordena, sacando los elementos del heap, sin embargo el quicksort empieza a ordenar desde el primer momento y es por ello que este es más rapido. La comparación entre mergesort y heapsort y su parecido es debido a que ambos reservan memoria extra, que es lo que los diferencia a fin de cuentas del quicksort.
...
En cuánto a lo que vemos en esta gráfica, podemos ver la gran diferencia entre los algoritmos quicksort, mergesort y heapsort con respecto a los cuadráticos, principalmente el algoritmo de selección e insercción. Podemos ver también que dentro de este conjunto de algoritmos, como hemos explicado anteriormente, el peor algoritmo es el de la burbuja.
...
- **Iván :** HP - 2 GB de RAM - Intel(R) Core(TM) i7-3630QM CPU @ 2.40GHz
...
| Tamaño del Vector | Andrés | Antonio | Iván | Juanlu |
|-------------------|--------|---------|------|--------|
|40000|0.006235|0.012287|0.007532|0.245822|
|520000|0.082585|0.118127|0.103365|0.272054|
|1000000|0.178312|0.229693|0.204994|0.583711|

### Conclusion ###

Tras ver los resultados de las distintas tablas, observamos que las prestaciones del ordenador de Andrés es claramente mas rápido que los demás, y que la máquina utilizada por JuanLuis es claramente más lento, que era lo que se esperaba previo al experimento. Aun así, pese a la mejora de las prestaciones del ordenador de Andres, es claro que si el algorítmo es cúbico o exponencial, estas mejoras harán eterno el tiempo de espera, como es el caso de las torres de hanoi. Igualmente, un algorítmo muy rápido como el quicksort al compararlo en varias máquinas vemos que tampoco difiere mucho en cuanto a tiempos y que es mucho más importante este hecho que las prestaciones.
