...
- Queremos conseguir la mejor solución exponencial posible.
...
## Primer algoritmo ($\theta(m^{n})$) {.smaller .smaller .smaller}
...
- No nos importa cuál sea la máquina que realiza un determinado trabajo. Todas son igual de eficientes.
- **Problema**: el algoritmo anterior calcula por separado permutaciones que dan soluciones equivalentes.
- **Solución**: si quedan máquinas sin tareas solo llamamos al algoritmo recursivo para la primera.
...
## Soluciones recorridas por el tercer algoritmo
...
## Comparación de soluciones recorridas
...
$\centerline{\includegraphics[width=10cm]{../../../Code/NumSols/Imagenes/grafica_tiempos_todos_constante_Trabajadores.png}}$

# Análisis empírico

$\centerline{\includegraphics[width=10cm]{../../../Code/NumSols/Imagenes/grafica_tiempos_todos_constante_Trabajos.png}}$

# Análisis empírico

$\centerline{\includegraphics[width=10cm]{../../../Code/NumSols/Imagenes/grafica_tiempos_constante_Trabajadores.png}}$

# Análisis empírico

$\centerline{\includegraphics[width=10cm]{../../../Code/NumSols/Imagenes/grafica_tiempos_constante_Trabajos.png}}$

# Análisis empírico

$\centerline{\includegraphics[width=10cm]{../../../Code/NumSols/Imagenes/grafica_tiempos_dos_mejores_constante_Trabajadores.png}}$

# Análisis empírico

$\centerline{\includegraphics[width=10cm]{../../../Code/NumSols/Imagenes/grafica_tiempos_dos_mejores_constante_Trabajos.png}}$
