...
Para probar cada uno de los algorímos experimentalmente, y que todos ellos se ejecutasen sobre el mismo grafo(o arbol) hemos implementado dos generadores tanto de arbol como de grafos aleatórios. En el primero usámos, además de el número de nodos para generar el grafo, el concepto de densidad de grafo para generarlos con más o menos aristas. Este hecho influye en el tiempo de ejecución de los algorítmos. En el segundo usamos el número de hijos máximo, hecho que tambien lo hace. No incluiremos el estudio de el cámbio en tiempo de ejecución con respecto a estos parámetros, aunque si lo notaremos como anécdota.
